...
```{r echo=FALSE, fig.cap="Gaussian distributions of vehicles.", fig.width=14, fig.height=3}
...
```{r echo=FALSE, fig.cap="Histogram of severity distribution.", fig.width=9, fig.height=4}
...
```{r echo=FALSE, warning=FALSE, message=FALSE, fig.width=6, fig.height=3, fig.cap="Theoretical derivation validation using guassian distribution"}
